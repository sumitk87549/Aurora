    ...
    public ResponseEntity<byte[]> getPublicImage(@PathVariable Long id) {
        ...
        if (image.getImageData() == null || image.getImageData().length == 0) {
            byte[] defaultImage = new byte[] {
                ...
                0x00, 0x00, 0x00, 0x0A, 0x49, 0x44, 0x41, 0x54, 0x78, (byte)0x9C, 0x63, 0x00, 0x01, 0x00, 0x00, 0x05, 0x00, 0x01,
                0x0D, 0x0A, 0x2D, (byte)0xB4, 0x00, 0x00, 0x00, 0x00, 0x49, 0x45, 0x4E, 0x44, (byte)0xAE, 0x42, 0x60, (byte)0x82
            };
